export default class SplashScreen extends Phaser.Scene {
  ...
  // Takes care of loading the main game assets, including textures, tile maps, sound effects and other binary files, while displaying a busy splash screen.
  ...
  preload() {
    ...
    //  Declaring all game assets to be loaded here.
    this.load
      .image('letter')
      .image('textbox')
      .image('menubox')
    ...
    this.load
      .atlas('hoodgirl', 'hoodgirl1.png', 'hoodgirl1.json')
    ...
    this.load
      ...
      .audio('stab', 'stab.mp3')
      .audio('adventurestinger', 'assaultAdventureStinger.wav');
  }

  // Set up animations, plugins etc. that depend on the game assets we just loaded.
